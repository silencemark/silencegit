...
public class MoneyUtils {
	private static String appid = Constants.APPID;// 应用ID
	private static String appsecret = Constants.APPSECRET;// 应用密钥
	private static String partner = Constants.PARTNER;// 微信支付商户号
	private static String partnerkey = Constants.PARTNERKEY;
	...
	final static String KEYSTORE_FILE = "D:/apiclient_cert.p12";
	final static String KEYSTORE_PASSWORD = Constants.PARTNER;
