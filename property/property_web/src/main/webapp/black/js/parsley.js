    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , phone:      "请输入有效的电话号码"
          , idcard:		"请输入有效的身份证号"
          , alphanum_:	"只允许输入英文字母、数字和下划线"
          , name:		"只允许输入汉字、数字、字母、下划线不能以下划线开头和结尾"
          , uri:		"只允许输入英文字母、数字、下划线和斜线"
        }
      , notnull:        "不能为空"
    ...
    */
    , validators: {
      ...
      , greaterthan: function(val,elem,self) {
		 ...
		 var v3=$( elem ).val().split(":");
		 var v4=v3[0]+v3[1];
		 var start=parseInt(v4);
 		 return end>start;
 	  }
      , ipport: function(val){
