...
.form fieldset div.l div.i {
	...
	<div class="content">
									...
									<div class="i">
										<div class="wcInputs" id="wcInputs" data-msgtype="${pvMap.msgtype}"
											...
											<div class="hd clearFix">
												<c:choose><c:when test="${null == pvMap.templettype or '' == pvMap.templettype}" >
		...
		function saveContent(msgtype,content){
			var url = "<%=request.getContextPath()%>/ws/backer/wxset/saveReplyNoKeyword?a=1";
