		...
		<div class="webMain"  style="width: 100%">
			<div class="mainHeader">
				...
				<ul class="menu clearFix">
					...
					<li class="current"><a href="<%=request.getContextPath() %>/ws/backer/wxset/findMessageAuditPass">已通过(${auditSuccessCount })</a></li>
			...
			<div class="mainBody">
 				...
 				<!-- 查询条件 -->
 				<form id="memberform" action="<%=request.getContextPath() %>/ws/backer/wxset/findMessageAuditPass" method="post">
					...
					<table class="table" id="userTable">
						...
						<tbody>
							...
							<tr> 
								...
								<td align="t3"><fmt:formatDate value="${item.sendtime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							</tr>
							</c:forEach>
						</tbody>
						<tfoot>
