        ...
        <div class="crumb">
            ...
            <div class="row">
                <div class="col-md-12" role="main">
                    <h3 class="current-tit"><span>省份管理</span></h3>
                            	...
                            	<c:forEach items="${provinceList}" var="item" varStatus="st">
                            		...
                            		<input type="hidden" id="ifactive_${item.areaid}" value="${item.ifactive }"/>
                            		 <tr>
	                                    ...
	                                    <td><center>
											<a href="<%=request.getContextPath()%>/system/getAreaDic?parentid=${item.areaid}&fromid=city" data-toggle="modal" data-backdrop="static"><i class="ico-about"></i>详细</a>
...
<div id="save_edit" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <input type="hidden" value="${map.parentid }" name="parentid"  />
        <input type="hidden" value="${map.fromid }" name="fromid"  />
        <input type="hidden" value="1" name="areatype"  />
