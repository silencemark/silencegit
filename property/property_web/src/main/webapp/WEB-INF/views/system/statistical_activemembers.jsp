...
<body class="p-statistical p-statistical-active">
<div class="wrapper">
                ...
                <div class="col-md-12" role="main">
                    ...
                    <c:choose>
                    	<c:when test="${ifcheck==1}">
	                    	<span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=1'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:2px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当月每日)</span>
		                    <span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=2'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:0px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当月每周)</span>
		                    <span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=3'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:0px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当年每月)</span>
                    	</c:when>
                    	<c:when test="${ifcheck==2}">
                    		<span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=1'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:0px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当月每日)</span>
		                    <span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=2'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:2px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当月每周)</span>
		                    <span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=3'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:0px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当年每月)</span>
                    	</c:when>
                    	<c:when test="${ifcheck==3}">
                    		<span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=1'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:0px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当月每日)</span>
		                    <span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=2'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:0px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当月每周)</span>
		                    <span onclick="location.href='<%=request.getContextPath() %>/system/activemembers?ifcheck=3'" style="display:inline-block;padding:0 8px 4px 3px;height:26px;border-bottom:2px solid #1badf2;text-decoration: none;width: 210px;text-align: center;cursor: pointer;">会员统计(当年每月)</span>
                    	</c:when>
                    </c:choose>
                    </h3>
                    <div class="row area-list-dec">
                        <div class="area-search">
                            <form class="form-inline" method="post" action="<%=request.getContextPath()%>/system/activemembers">
...
require(
  ...
  <form action="<%=request.getContextPath() %>/system/clickactivemembers" id="v_form" method="post">
