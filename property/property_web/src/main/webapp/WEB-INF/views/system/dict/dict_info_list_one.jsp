                ...
                <div class="col-md-12" role="main">
                    ...
                    <div class="row area-list-dec">
                        <div class="area-search">
                            <form class="form-inline" method="post" action="<%=request.getContextPath()%>/system/dic/getDicInfoList?parentid=${param.parentid}&datatypeid=${param.datatypeid}">
                                ...
                                <div class="form-search-sub" style="margin-left:30px;">
                                    ...
                                    <a data-toggle="modal" data-backdrop="static" href="<%=request.getContextPath()%>/system/dic/getDicList?datatypeid=${param.datatypeid}"  style="margin-left:30px" type="button" class="btn btn-default">返回类型列表</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
<div id="save_edit" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form id="saveEditForm" class="form-horizontal parsley-form"  method="post" name="saveEditForm" action="<%=request.getContextPath() %>/system/dic/editDic?st=1"> 
        	<input type="hidden" id="dataid" name="dataid"  />
        	<input type="hidden" id="typeid" name="typeid" value="${param.datatypeid }"  />
