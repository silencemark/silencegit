...
public interface WeiXinSetMapper {
	...
	String getMaxDTImgTextID(Map<String, Object> data);
	void deleteDTImgTextItem(Map<String, Object> data) ;
	void insertDTImgTextItem(Map<String, Object> data) ;
	void updateDTImgTextItem(Map<String, Object> data) ;
	Map<String, Object> getDTImgTextItem(Map<String, Object> data) ;
	...
	List<Map<String, Object>> getDTImgTextChildList(Map<String, Object> data);
	...
	Integer getGTYGroupCount(Map<String, Object> data);
	...
	Integer getDTGroupListNum(Map<String,Object> data);
	...
	Map<String, Object> getSYNoticeSend(Map<String, Object> data);
